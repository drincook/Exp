...
const Hero: React.FC<{ posts: PostTypes[] }> = ({ posts }) => {
  ...
  return (
    <section className="relative">
      <div className="w-[95%] mx-auto max-w-[1450] z-1">
        {topFeatured.map((post) => (
          ...
          >
            ...
            <h2 className="test-4xl md:text-6xl font-extrabold uppercase text-tertiary">
              {post.title}
            </h2>
        ...
        <div className="grid grid-cols-3 gap-8 max-lg:grid-cols-1">
          {bottomFeatured.map((post) => (
            ...
            >
              ...
              <Tag text={post.category} />
              <h3 className="text-sm md:text-2xl font-extrabold uppercase text-tertiary px-5">
                {post.title}
              </h3>
